...
from typing import Any, Iterable, cast, ClassVar, NamedTuple, Literal
...
class Entity(NamedTuple):
    ...
    def from_tuple(t: tuple[str, str]) -> Entity:
        ...
        if not (
            ...
            raise ValueError(
                f"Expected tuple[str, str], got {type(t).__name__}: {t}"
            )
...
class KnowledgeGraph(nx.MultiDiGraph):
    ...
    def add_nodes_from(
        self,
        nodes: Iterable[
            Entity | tuple[str, str] | tuple[Entity, dict[Any, Any]]
        ],
        **attr,
    ) -> None:
        """
    ...
    def add_edge(
        ...
        **attr : dict
        ...
        self.schema.register_edge_usage(
        ...
        **attr : dict
        ...
        for e in ebunch:
            if len(e) == 4:
                ...
                raise ValueError(
                    f"Edge tuple {e} must be a 2-, 3-, or 4-tuple"
                )
    ...
    def add_typed_edge(
        ...
        **attr,
        ...
        return self.add_edge(
            (head_name, head_type), (tail_name, tail_type), **attr
        )
    ...
    def _visualize_static(
        ...
        **kwargs,
        ...
        nx.draw_networkx_nodes(
            self, pos, node_color=node_colors, node_size=node_size
        )
