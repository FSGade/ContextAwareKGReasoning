...
echo "=========================================="
echo "GRAPH VISUALIZATION (Prototype)"
echo "=========================================="
...
python /home/projects2/ContextAwareKGReasoning/ContextAwareKGReasoning/scripts/viz_helper_2.py
