#!/bin/bash
#SBATCH --job-name=plot_prob_dist
...
echo "=========================================="
echo "PROBABILITY DISTRIBUTION PLOTS"
echo "=========================================="
...
python /home/projects2/ContextAwareKGReasoning/ContextAwareKGReasoning/scripts/plot_distributions_simple.py
